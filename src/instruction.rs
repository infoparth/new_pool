...
mod tests {
    ...
    fn pack_intialize() {
        ...
        let burn_fee_numerator: u64 = 5;
        let burn_fee_denominator: u64 = 20;
        let fees = Fees {
            trade_fee_numerator,
        ...
        expect.extend_from_slice(&burn_fee_numerator.to_le_bytes());
        expect.extend_from_slice(&burn_fee_denominator.to_le_bytes());
